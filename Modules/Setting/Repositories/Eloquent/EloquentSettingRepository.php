...
class EloquentSettingRepository extends EloquentBaseRepository implements SettingRepository
{
    ...
    public function moduleSettings($modules)
    {
        if (is_string($modules)) {
            return config('sorter.' . strtolower($modules) . ".settings");
        }

        $modulesWithSettings = [];
        foreach ($modules as $module) {
            if ($moduleSettings = config('sorter.' . strtolower($module->getName()) . ".settings")) {
    ...
    /**
     * Return a setting name using dot notation: sorter.{module}.settings.{settingName}
     * @param string $settingName
     * @return string
     */
    private function getConfigSettingName($settingName)
    {
        ...
        return "sorter.{$module}.settings.{$setting}";
    }

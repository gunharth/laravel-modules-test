...
trait CanPublishConfiguration
{
    ...
    public function publishConfig($module, $fileName)
    {
        ...
        $this->mergeConfigFrom($this->getModuleConfigFilePath($module, $fileName), strtolower("sorter.$module.$fileName"));
        $this->publishes([
            $this->getModuleConfigFilePath($module, $fileName) => config_path(strtolower("sorter/$module/$fileName") . '.php'),
        ], 'config');
    }
